...
export async function POST(request: Request) {
  try {
    ...
    if (scraped && scraped.length > 0) {
      ...
      faresData = {
        "Bike": [{ id: "b1", name: "Uber Bike", provider: "Uber", category: "Bike", price: 105, durationMinutes: 20, etaMinutes: 5, deeplink: "#", discountApplied: null }],
        "Auto": [{ id: "a1", name: "Uber Auto", provider: "Uber", category: "Auto", price: 195, durationMinutes: 23, etaMinutes: 6, deeplink: "#", discountApplied: null }],
